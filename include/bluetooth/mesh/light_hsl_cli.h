...
/** @def BT_MESH_LIGHT_HSL_CLI_INIT
 *
 * @brief Initialization parameters for a @ref bt_mesh_light_hsl_cli instance.
 */
#define BT_MESH_LIGHT_HSL_CLI_INIT(_handlers)                                  \
	{                                                                      \
		.handlers = _handlers,                                         \
...
/**
 * Light HSL Client instance. Should be initialized with
 * @ref BT_MESH_LIGHT_HSL_CLI_INIT.
 */
struct bt_mesh_light_hsl_cli {
	/** Model entry. */
 ...
 * @param[in] ctx Message context, or NULL to use the configured publish
 * parameters.
 * @param[in] set HSL Hue state to set.
 * @param[in] rsp Response status buffer, or NULL to keep from blocking.
 *
 * @retval 0 Successfully sent the message and populated the @c rsp buffer.
 * @retval -EALREADY A blocking request is already in progress.
 ...
 * @param[in] ctx Message context, or NULL to use the configured publish
 * parameters.
 * @param[in] set HSL Saturation state to set.
 * @param[in] rsp Response status buffer, or NULL to keep from blocking.
 *
 * @retval 0 Successfully sent the message and populated the @c rsp buffer.
 * @retval -EALREADY A blocking request is already in progress.
